...
<div className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-8 mb-12">
  ...
  <a 
    ...
    target="_blank" 
    rel="noopener noreferrer"
    className="flex items-center space-x-2 bg-gray-800/50 backdrop-blur-sm px-6 py-3 rounded-full border border-blue-700 hover:border-blue-400 transition-colors w-full sm:w-auto justify-center"
  >
    <TelegramIcon className="w-6 h-6" />
    <span>Все отзывы</span>
  </a>
